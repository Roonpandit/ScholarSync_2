  ...
  const teacherSteps = [
    {
      ...
      description:
        "Access your personalized teacher dashboard with comprehensive class management tools and attendance oversight capabilities.",
      details: [
    ...
    },
    {
      ...
      description:
        "Set up and manage attendance tracking sessions for your classes with precise timing controls and student group assignments.",
      details: [
    ...
    },
    {
      ...
      description:
        "Track student attendance in real-time with live photo verification, location tracking, and instant completion notifications.",
      details: [
    ...
    },
    {
      ...
      description:
        "Manage students within your assigned classes with secure, limited permissions designed to protect sensitive student data.",
      details: [
    ...
    },
    {
      ...
      description:
        "Generate comprehensive attendance reports with advanced filtering options and detailed analytics for your teaching assignments.",
      details: [
    ...
    },
    {
      ...
      description:
        "Stay connected with students, parents, and administration through integrated communication tools and automated notification systems.",
      details: [
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-8 mb-8">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Your comprehensive guide to managing student attendance,
                tracking academic progress, and streamlining classroom
                administration
              </p>
            </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-sm sm:text-base text-indigo-700 leading-relaxed space-y-2">
                    ...
                    <p>
                      <strong>Login Credentials:</strong> You have received your
                      login credentials via email when your account was created
                      by the school administrator. Please check your inbox for
                      the welcome email containing your username and password.
                    </p>
                    <p>
                      <strong>First Time Login:</strong> After logging in for
                      the first time, you'll be prompted to change your password
                      for security purposes. Please choose a strong password
                      that you can remember.
                    </p>
                    <p>
                      <strong>Forgot Password:</strong> If you cannot locate
                      your credentials or need to reset your password, use the
                      "Forgot Password" link on the login page and enter your
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-sm sm:text-base text-amber-700 leading-relaxed space-y-2">
                    <p>
                      <strong>Enhanced Security:</strong> Your teacher account
                      has been configured with specific permissions to ensure
                      data security and prevent accidental modifications to
                      critical student records.
                    </p>
                    <p>
                      <strong>Cannot Delete:</strong> For security reasons,
                      teachers cannot delete student accounts or attendance
                      slots. This preserves academic records and maintains
                      proper audit trails.
                    </p>
                    <p>
                      <strong>Class-Specific Access:</strong> You can only view
                      and manage students assigned to your classes, ensuring
                      privacy and data protection.
                    </p>
                    <p>
                      <strong>Administrative Support:</strong> If you need to
                      make changes that require administrative privileges,
                      please contact the school's ScholarSync administrator.
                    </p>
                  </div>
                </div>
              </div>
