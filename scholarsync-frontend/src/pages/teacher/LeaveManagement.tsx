...
interface LeaveRequestData {
  id: string;
  studentId: LeaveStudent | null;
  lectureId: LeaveLecture | null;
...
const TeacherLeaveManagement = () => {
  ...
  const fetchPendingRequests = async () => {
    setLoading(true);
    try {
      const response = await get<LeaveListResponse>(API_ENDPOINTS.LEAVE.LIST, { status: 'pending' });
  ...
  const fetchAllRequests = async () => {
    ...
    try {
      ...
      const response = await get<LeaveListResponse>(API_ENDPOINTS.LEAVE.LIST, params);
  ...
  const handleApprove = async (requestId: string) => {
    ...
    try {
      await post<LeaveManageResponse>(API_ENDPOINTS.LEAVE.MANAGE(requestId), { action: 'approve' });
  ...
  const handleReject = async () => {
    ...
    setActionLoading(true);
    try {
      await post<LeaveManageResponse>(API_ENDPOINTS.LEAVE.MANAGE(selectedRequest.id), {
        action: 'reject',
        teacherRemark,
      });
  ...
  const renderRequestCard = (request: LeaveRequestData): ReactNode => (
    <div
      key={request.id}
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className={`text-sm font-medium ${request.leaveType === 'sick' ? 'text-red-700' : 'text-blue-700'}`}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="font-medium">{calculateDays(selectedRequest.fromDate, selectedRequest.toDate)} day(s)</p>
                </div>
                <div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-lg w-full">
            ...
            <div className="p-6">
              <div className="mb-4 p-3 bg-yellow-50 rounded-md">
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-yellow-800">
                    Student will have 48 hours to resend this request with a remark. After that, the request will be
              ...
              />
              <p className="mt-1 text-sm text-gray-500">This remark will be visible to the student</p>
            </div>
