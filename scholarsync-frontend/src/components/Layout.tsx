              ...
              {(user?.role === "admin" || user?.role === "teacher") ? (
                <div className="space-y-1">
                  ...
                  <NavItem
                    ...
                    isActive={isActive(ROUTE_CONSTANTS.DASHBOARD)}
                    icon={
                  ...
                  <NavItem
                    ...
                    isActive={isActive(ROUTE_CONSTANTS.STUDENTS)}
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  {user?.role === "admin" && (
                    <NavItem
                      to={ROUTE_CONSTANTS.TEACHERS}
                      isActive={isActive(ROUTE_CONSTANTS.TEACHERS)}
                      icon={
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <NavItem
                    to={ROUTE_CONSTANTS.REVIEWS}
                    isActive={isActive(ROUTE_CONSTANTS.REVIEWS)}
                  ...
                  <NavItem
                    ...
                    isActive={isActive(ROUTE_CONSTANTS.ATTENDANCE_SLOTS)}
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <NavItem
                    ...
                    isActive={isActive(ROUTE_CONSTANTS.ATTENDANCE_STATS)}
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  {user?.role === "admin" && (
                    <>
                      ...
                      <NavItem
                        to={ROUTE_CONSTANTS.IP_MANAGEMENT}
                        isActive={isActive(ROUTE_CONSTANTS.IP_MANAGEMENT)}
                        icon={
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <NavItem
                        ...
                        isActive={isActive(ROUTE_CONSTANTS.LECTURE_MANAGEMENT)}
                        icon={
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <NavItem
                    ...
                    isActive={isActive(ROUTE_CONSTANTS.LEAVE_MANAGEMENT)}
                    icon={
                ...
                <div className="space-y-1">
                  ...
                  <NavItem
                    to={ROUTE_CONSTANTS.STUDENT_DASHBOARD}
                    isActive={isActive(ROUTE_CONSTANTS.STUDENT_DASHBOARD)}
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                      </svg>
                  ...
                  <NavItem
                    to={ROUTE_CONSTANTS.STUDENT_MARK_ATTENDANCE}
                    isActive={isActive(ROUTE_CONSTANTS.STUDENT_MARK_ATTENDANCE)}
                    badge={true}
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <NavItem
                    to={ROUTE_CONSTANTS.STUDENT_ATTENDANCE}
                    isActive={isActive(ROUTE_CONSTANTS.STUDENT_ATTENDANCE) || location.pathname.startsWith('/student/attendance')}
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                      </svg>
                  ...
                  <NavItem
                    to={ROUTE_CONSTANTS.STUDENT_LEAVE}
                    isActive={isActive(ROUTE_CONSTANTS.STUDENT_LEAVE)}
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M17.414 2.586A2 2 0 0016 2H6a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-.586-1.414zM6 4h8v2H6V4zm0 4h5v2H6V8zm0 4h8v2H6v-2zm9 4h-1v1h1v-1z" />
                      </svg>
...
const NavItem: React.FC<NavItemProps> = ({ to, isActive, icon, children, badge = false }) => {
  return (
    <Link
      to={to}
      className={`
