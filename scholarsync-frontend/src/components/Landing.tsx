import { useState, useRef, type FC, type LucideIcon } from "react";
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <div className="mt-5 sm:mt-8 flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-3">
                  ...
                  <button
                    onClick={() => navigate(ROUTE_CONSTANTS.DOCUMENTATION)}
...
export default ScholarSyncLanding;
