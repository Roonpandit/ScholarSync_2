    ...
    const studentSteps = [
        {
            ...
            description: "Access your personalized student portal with comprehensive attendance tracking, academic progress monitoring, and quick action tools.",
            details: [
        ...
        },
        {
            ...
            description: "Use the advanced photo verification system to mark your attendance for active classes with location tracking and instant confirmation.",
            details: [
        ...
        },
        {
            ...
            description: "Track and review your complete attendance history with detailed records, photo verification logs, and performance analytics.",
            details: [
        ...
        },
        {
            ...
            description: "Monitor and analyze your absent records with detailed insights to improve attendance patterns and academic performance.",
            details: [
        ...
        },
        {
            ...
            description: "Apply for various types of academic leave with proper documentation, automated email processing, and approval tracking.",
            details: [
        ...
        },
        {
            ...
            description: "Manage your personal information, account security settings, and communication preferences with enhanced privacy controls.",
            details: [
        ...
        },
        {
            ...
            description: "Stay connected with your academic community through integrated messaging, alerts, and important announcements.",
            details: [
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-14 sm:h-16">
                        <div className="flex items-center">
                            ...
                            <h2 className="text-sm sm:text-xl font-semibold text-gray-700">Student Guide</h2>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="mt-16 sm:mt-20">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-8 mb-8">
                        <div className="text-center mb-8 sm:mb-12">
                            ...
                            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto">
                                Your comprehensive guide to managing attendance, tracking academic progress, and staying connected with your educational journey
                            </p>
                        </div>
                        ...
                        <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4 sm:p-6 mb-6">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-semibold text-indigo-800 mb-2">Student Portal Access</h3>
                                    <div className="text-sm sm:text-base text-indigo-700 leading-relaxed space-y-2">
                                        ...
                                        <p>
                                            <strong>Login Credentials:</strong> You received your login credentials via email when your account was created by the school administrator. Please check your inbox for the welcome email containing your student ID and password.
                                        </p>
                                        <p>
                                            <strong>First Time Login:</strong> After logging in for the first time, you may be prompted to change your password for security. Choose a strong password that includes letters, numbers, and symbols.
                                        </p>
                                        <p>
                                            <strong>Account Issues:</strong> If you cannot find your credentials or need help accessing your account, use the "Forgot Password" option or contact your teacher/administrator immediately.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 sm:p-6 mb-6">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-semibold text-amber-800 mb-2">Important Guidelines</h3>
                                    <div className="text-sm sm:text-base text-amber-700 leading-relaxed space-y-2">
                                        <p>
                                            <strong>Account Security:</strong> Students cannot create accounts independently. All student accounts are created by administrators to ensure proper enrollment and security.
                                        </p>
                                        <p>
                                            <strong>Photo Verification:</strong> You must take a clear selfie for each attendance marking. Make sure your face is clearly visible and you're in good lighting.
                                        </p>
                                        <p>
                                            <strong>Location Requirement:</strong> Attendance marking requires you to be within the designated classroom or campus area as specified by your teacher.
                                        </p>
                                        <p>
                                            <strong>Time Windows:</strong> Each attendance slot has specific timing. Late submissions may not be accepted, so mark your attendance promptly when slots become active.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-xl p-4 sm:p-6">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-2">Benefits of Regular Attendance</h3>
                                    <div className="text-sm sm:text-base text-green-700 leading-relaxed space-y-2">
                                        <p>
                                            <strong>Academic Success:</strong> Regular attendance is directly linked to better academic performance and understanding of subject matter.
                                        </p>
                                        <p>
                                            <strong>Scholarship Eligibility:</strong> Many scholarships and academic programs require minimum attendance percentages for eligibility.
                                        </p>
                                        <p>
                                            <strong>Progress Tracking:</strong> Use the attendance analytics to identify patterns and improve your academic engagement.
                                        </p>
                                        <p>
                                            <strong>Future Opportunities:</strong> Good attendance records are valuable for college applications, job interviews, and character references.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-8">
                        <div className="text-center mb-8 sm:mb-12">
                            <h2 className="text-xl sm:text-3xl font-bold text-gray-900 mb-4">Complete Student Guide</h2>
                            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
                                Follow these detailed steps to master all features of the ScholarSync Student Portal
                            </p>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-8 mt-8">
                        <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Quick Tips for Success</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                ...
                                <div className="bg-green-50 p-4 rounded-lg">
                                    ...
                                    <ul className="text-sm text-gray-700 space-y-1">
                                        <li>• Check for active slots regularly throughout the day</li>
                                        <li>• Mark attendance as soon as slots become active</li>
                                        <li>• Set phone reminders for important classes</li>
                                        <li>• Don't wait until the last minute to mark attendance</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 sm:p-8 mt-8">
                        <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Common Issues & Solutions</h3>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <div className="bg-white p-4 rounded-lg shadow-sm">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Camera Not Working</h4>
                                ...
                                <div className="bg-white p-4 rounded-lg shadow-sm">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Location Issues</h4>
                                    <div className="text-sm text-gray-700 space-y-1">
                                        ...
                                        <p>• Contact teacher if location requirements are unclear</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="bg-white p-4 rounded-lg shadow-sm">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Attendance Not Marked</h4>
                                    <div className="text-sm text-gray-700 space-y-1">
                                ...
                                <div className="bg-white p-4 rounded-lg shadow-sm">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Login Problems</h4>
                                    <div className="text-sm text-gray-700 space-y-1">
                    ...
                    <div className="bg-gray-900 rounded-xl text-white p-4 sm:p-8 mt-8">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-gray-300 mb-6">Our support team and your teachers are here to help you succeed with ScholarSync.</p>
                        </div>
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-gray-400 text-sm">
                                For immediate assistance with attendance issues, contact your class teacher or academic coordinator.
                            </p>
                        </div>
                    </div>
                </div>
