...
import { Eye, EyeOff, Key, Check, X, CheckCircle, XCircle } from 'lucide-react';
...
const ResetPassword = () => {
  ...
  // Password validation rules (from first code)
  const validations = {
  ...
  // Check if passwords match (from first code)
  const passwordsMatchFirst = password && confirmPassword && password === confirmPassword;

  // Check if all validations pass (from first code)
  ...
  const handleSubmit = async (e) => {
    ...
    // Check validations from first code
  ...
  // ValidationItem component from first code
