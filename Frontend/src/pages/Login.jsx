            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center mt-1">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-xs text-gray-600 cursor-pointer hover:text-gray-800 transition-colors">
                    Remember me
                  </label>
                </div>
            ...
            <div className="flex items-center justify-center space-x-6">
              <button className="flex items-center justify-center p-2 border border-gray-300 rounded-full bg-white hover:bg-gray-50 transition-colors">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M4.17 14.595l3.258-2.538c-.75-2.199-3.18-3.355-5.624-2.605-2.445.75-3.6 3.18-2.85 5.625.75 2.445 3.179 3.6 5.624 2.85a4.723 4.723 0 0 0 2.05-1.162l-2.458-2.17z" fill="#34A853"/>
                  <path d="M12 20.571c2.24 0 4.12-.747 5.496-2.019l-2.665-2.073c-.748.997-1.91 1.57-3.16 1.57-2.207 0-4.067-1.49-4.727-3.494h-2.59v2.187A8.33 8.33 0 0 0 12 20.571z" fill="#FBBC05"/>
                  <path d="M7.273 13.414a5.073 5.073 0 0 1 0-3.214v-2.187H4.17a8.52 8.52 0 0 0 0 7.588l3.103-2.187z" fill="#EA4335"/>
                </svg>
              </button>
              <button className="flex items-center justify-center p-2 border border-gray-300 rounded-full bg-white hover:bg-gray-50 transition-colors">
